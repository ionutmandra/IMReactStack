...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        var sl0 = new ScrollMagic.Scene({ triggerElement: '#sectionContent1', triggerHook: 'onLeave', duration: '100%', offset: 100 })
            .addIndicators().addTo(controller).setTween(tlm);

        new ScrollMagic.Scene({ triggerElement: '#sectionContent1', triggerHook: 'onLeave', duration: '100%' })
            .addIndicators().addTo(controller).setTween(scale_tweenr232kk);

        var sl01 = new ScrollMagic.Scene({ triggerElement: '#sectionContent1', triggerHook: 'onLeave', })
            .setPin('#sectionContent1').addIndicators().addTo(controller);
            
            
        //  new ScrollMagic.Scene({ triggerElement: '#sectionContent1', triggerHook: 'onLeave', duration: '100%', offset:  })
        ...
        var scale_tween21 = TweenMax.to('#anim21', 0.5, { x: '0%', ease: Linear.easeNone });
        var scale_tween22 = TweenMax.to('#anim22', 0.5, { x: '0%', ease: Linear.easeNone });
        var scale_tweenr23 = TweenMax.to('#anim23', 0.5, { x: '0%', ease: Linear.easeNone });
        tlm2.add([grtw, scale_tween21, scale_tween22, scale_tweenr23]);

        var scale_tween212 = TweenMax.to('#anim21', 0.5, { x: '-100%', ease: Linear.easeNone });
        var scale_tween222 = TweenMax.to('#anim22', 0.5, { x: '-100%', ease: Linear.easeNone });
        var scale_tweenr232 = TweenMax.to('#anim23', 0.5, { x: '+100%', ease: Linear.easeNone });
        tlm2.add([scale_tween212, scale_tween222, scale_tweenr232]);

        var sl1 = new ScrollMagic.Scene({ triggerElement: '#sectionContent2', triggerHook: 'onLeave', duration: '100%' })
            .setTween(tlm2).addIndicators().addTo(controller);

        var sl21 = new ScrollMagic.Scene({ triggerElement: '#sectionContent2', triggerHook: 'onLeave', })
            .setPin('#sectionContent2').addIndicators().addTo(controller);
        ...
        new ScrollMagic.Scene({ triggerElement: '#sectionContent2', triggerHook: 'onLeave', duration: '100%' })
            .addIndicators().addTo(controller).setTween(scale_tweenr2322kk);
        ...
        tlm3.add([grtw3, scale_tween31, scale_tween32]);
        ...
        tlm4.add([grtw4, scale_tween41]);

        new ScrollMagic.Scene({ triggerElement: '#sectionContent4', triggerHook: 'onLeave',duration:'100%' })
            .addIndicators().setTween(tlm4).addTo(controller);

        new ScrollMagic.Scene({ triggerElement: '#sectionContent4', triggerHook: 'onLeave',duration:'100%' })
            .setPin('#sectionContent4').addIndicators().addTo(controller);
    }
